...
{
    [Serializable]
    public class DataStreamMsg : Message
    {
        public const string k_RosMessageName = "ur5_intpro/DataStream";
        ...
        public DataStreamMsg(Sensor.ImageMsg Image, float[] x_image, float[] y_image, float[] x_world, float[] y_world, float[] z_world, float[] x, float[] y, float[] joint_angles, string[] obj_names, long data_counter)
        {
            this.Image = Image;
        ...
        public static DataStreamMsg Deserialize(MessageDeserializer deserializer) => new DataStreamMsg(deserializer);

        private DataStreamMsg(MessageDeserializer deserializer)
        {
            ...
            deserializer.Read(out this.x, sizeof(float), 4);
            deserializer.Read(out this.y, sizeof(float), 4);
